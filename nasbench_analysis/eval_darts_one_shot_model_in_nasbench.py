...
nasbench = NasbenchWrapper(
    dataset_file='/data/yiwei/nasbench_only108.tfrecord')
...
if __name__ == '__main__':
    config = dict(search_space='3')
    model = os.path.join('../experiments', 'nasp', 'search_space_3', 'search-exp-20200625-210845-2-3-3664', 'one_shot_architecture_50.obj')
    test_error, valid_error, runtime, params = eval_one_shot_model(config, model)